...
const navigation = [
  ...
  { href: "/passports", label: "Passeports", icon: QrCode },
  { href: "/safety-gate", label: "Veille Safety Gate", icon: Radar },
  { href: "/incidents", label: "Incidents et rappels", icon: AlertOctagon },
